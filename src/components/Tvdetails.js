...
function Tvdetails() {
  ...
  //console.log("tvdetails component rendered with id:", id);
  ...
  return info ? (
    <div
      ...
      className="relative w-screen h-[140vh] px-[10%] overflow-y-hidden overflow-x-hidden"
    >
      {/* part 1 navigation */}
      ...
      <div className="w-full flex">
        <img
          ...
          alt=""
        />
        <div className="content text-white relative">
          ...
          {/* <h1 className="text-xl mb-1 mt-1">tv Translated</h1>
          <p className="mb-4">{info.translations.slice(0, 10).join(" ")}</p> */}

          <div className="absolute mt-5 mb-5">
            <Link
